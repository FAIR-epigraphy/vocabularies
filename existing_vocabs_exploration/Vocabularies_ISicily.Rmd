...
1.  Load the I.Sicily dataset

You can download the latest dataset directly from Zenodo.

```{r}
download_zenodo("10.5281/zenodo.4431640", path = "./data")
```

2. Extract the zenodo repository
```{r}
unzip("./data/ISicily-v0.3beta.zip", exdir = "./data")
```

3. Read the XML files into a dataframe

One XML file
```{r}
isicily_xml <- read_xml("./data/ISicily-ISicily-cf52385/inscriptions/ISic0001.xml")


isicily_xml <- xmlToList("./data/ISicily-ISicily-cf52385/inscriptions/ISic0001.xml")
